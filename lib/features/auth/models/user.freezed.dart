...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, email: $email, name: $name, role: $role, status: $status, machineSerial: $machineSerial)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, email, name, role, status, machineSerial);
...
abstract class _User implements User {
  const factory _User(
      ...
      required final String machineSerial}) = _$UserImpl;
